...
export class QuotesComponent implements OnInit {
 quotes:Quote[] = [
    new Quote (1,'mike','Human spirit','The human spirit must prevail over technology to allow humans be in charge.','Albert Einstein', new Date(2021,7,22)),
    ...
    new Quote (3,'josh','The great myth','The great myth of our times is that technology is communication.','Libby Larsen',new Date(2021,6,3)),
    new Quote (4,'Beatrice','Communication','Communications tools don’t get socially interesting until they get technologically boring.','Clay Shirky',new Date(2021,7,17)),
